...
/**
 * 与t_user_infoModel形成映射，只允许在api接口与service之间传递<br>
 * @author autoTool 工具生成
 */
public  class TUserInfoDTOBase  implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TUserInfoDTOBase)) {
            return false;
        }

        final TUserInfoDTOBase otherDto = (TUserInfoDTOBase) other;
